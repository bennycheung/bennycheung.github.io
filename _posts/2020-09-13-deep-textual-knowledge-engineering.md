...
*Figure. Deep Knowledge system architecture shows the synergies between low-level NLP and high-level symbolic processor. By encoding the low-level segmented data into symbolic knowledge, human interaction can be improved by the traceable symbolic questions and answers.*
