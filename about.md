...
**Making AI Practical**: Philosophy is great, but shipping matters. I've written about "Lean AI" and managing LLM costs so GenAI ventures can actually survive. Theory without economics is just daydreaming.
...
*These AI-generated versions of me, rendered as toy figurines and crafted from different materials, came from training Stable Diffusion on my own photos. It's a strange thing, seeing yourself reflected through a machine's imagination. More on the process: [Dreambooth Training for Personal Embedding](https://bennycheung.github.io/dreambooth-training-for-personal-embedding).*
