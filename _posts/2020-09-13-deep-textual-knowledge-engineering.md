...
*Figure. Deep Knowledge system architecture shows the synergies between low-level NLP and high-level symbolic processor. By encoding the low-level segmented data into symbolic knowledge, the human interaction can be improved by the tracable symbolic questions and answers.*
